...
function updateBNB(price, e) {
    priceZEEXinBNB = (0.33 / price) * 1.05;
    console.log("PirceZEEXinBNB: " + priceZEEXinBNB.toFixed(6));

    if (e.value < 0.1) {
        e.innerHTML = `1 ZEEX = approx ${priceZEEXinBNB.toFixed(6)} BNB - 0.33 USD.`
    }
    ...
    //function() {
        ...
        //      priceBNBhelp.innerHTML = `Receive ${(this.value / 0.33).toFixed(4)} ZEEX! : )`;
        //      if (this.value < 30) {
        //        priceUSDThelp.innerHTML = "1 ZEEX = 0.33 USDT | 1 USDT = 3.0303 ZEEX."
        //      } 
